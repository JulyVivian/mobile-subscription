...
<style lang="less">
  .personal-box{
    padding: .4rem 0;
    .card{
      background: url('https://julyvivian.github.io/js_css_sources/card.png') no-repeat top center;
      height: 3.67rem;
